...
<header class="masthead d-flex">
	...
	<form action="modificarin.php" method="post" name="form">
<center>
<div class="col-md-4" >
		...
		<div class="form-group">
		<input class="form-control input-lg" type="text" placeholder="MAYOREO" name="mayoreo"><br></br>
		</div>
		<div class="form-group">
...
document.forms['form']['id'].value = num;
	...
	<script  type="text/javascript" src="js/conectain.js"></script>	
